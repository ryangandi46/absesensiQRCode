...
// $config['admin_group']                = array('admin','Operator');             // Default administrators group, use name
$config['admin_group']                = array('admin','Operator','Dosen');             // Default administrators group, use name
