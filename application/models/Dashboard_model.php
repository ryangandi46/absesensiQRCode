...
class Dashboard_model extends Ci_Model{
  ...
  function get_maxd($pl){
          $this->db->select('a.id_karyawan,a.nama_karyawan,b.nama_jabatan,d.alamat');
    ...
    function get_maxe($in){
     ...
     $sql2 = " SELECT a.alamat, COUNT(b.id_karyawan) as total_karyawan
    ...
    $sql4 = "SELECT	a.nama_karyawan,b.nama_jabatan,d.alamat, count(c.id_khd) as total_kehadiran
      ...
      function get_max($id){
          ...
          $select = array('a.alamat,count(b.id_karyawan) as total_karyawan');
