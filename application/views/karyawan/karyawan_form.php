                ...
                <div class="box-body">
                    <form role="form" id="myForm" data-toggle="validator" action="<?php echo $action; ?>" method="post">
                        <div class="form-group">
                            <label for="nama_karyawan" class="control-label">Nama Mahasiswa</label>
                            <div class="input-group">
                                <input type="text" class="form-control" name="nama_karyawan" id="nama_karyawan" data-error="Nama Mahasiswa harus diisi" placeholder="Nama Mahasiswa" value="<?php echo $nama_karyawan; ?>" required />
                        ...
                        <div class="form-group">
                            <label for="jabatan" class="control-label">Program Kuliah<?php echo form_error('jabatan') ?></label>
                            <div class="input-group">
                        ...
                        <div class="form-group">
                            <label for="gedung_id" class="control-label">Kelass<?php echo form_error('gedung') ?></label>
                            <div class="input-group">
