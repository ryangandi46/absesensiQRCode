        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview active">
                ...
                <ul class="treeview-menu menu-open" style="display: block;">
                    <li><a href="<?php echo base_url('karyawan') ?>"><i class="fa fa-user"></i> <span>DATA MAHASISWA</span></a></li>
                    <!-- <li><a href="<?php echo base_url('jabatan') ?>"><i class="fa fa-briefcase"></i> <span>DATA PROGRAM KULIAH</span></a></li>
                    <li><a href="<?php echo base_url('shift') ?>"><i class="fa fa-retweet"></i> <span>DATA KELAS</span></a></li>
            ...
            <li>
                <a href="<?php echo base_url('rekap') ?>">
                    <i class="fa fa-list-alt"></i> <span>REKAP ABSENSI</span>
                </a>
            </li>
        </ul>
        <?php endif; ?>
