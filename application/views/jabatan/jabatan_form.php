        ...
        <div class='col-xs-12'>
            <div class='box box-<?=$box?>'>
                <div class='box-header  with-border'>
                    <h3 class='box-title'>FORM PROGRAM KULIAH</h3>
                </div>
                <div class="box-body">
                    <form role="form" id="myForm" data-toggle="validator" action="<?php echo $action; ?>" method="post">
                        <div class="form-group has-feedback">
                            <label for="nama_jabatan"> Nama Program <?php echo form_error('nama_jabatan') ?></label>
                            <div class="input-group">
                                <input type="text" class="form-control" data-error="Nama Program harus diisi" name="nama_jabatan" id="nama_jabatan" placeholder="Nama Program" value="<?php echo $nama_jabatan; ?>" required />
